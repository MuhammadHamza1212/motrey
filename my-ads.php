...
<html lang="<?php echo $currentLanguageIsoCode; ?>" dir="<?php echo $currentLanguageDirection; ?>">
  ...
  <body>
	...
	<div class="container pt-5">
		<div class="heading mb-4" style="text-align:left;"><?php echo $labels[$currentLanguageIsoCode]['My_Ads'] ?></div>
		
		<!-- my ads filter start -->
		<?php include 'views/my-ads-filter.php' ?>
		<!-- my ads filter end -->
		
		<!-- my ads list start -->
		<?php include 'views/my-ads-list.php' ?>
		<!-- my ads list end -->
